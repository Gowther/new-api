...
func Relay(c *gin.Context, relayFormat types.RelayFormat) {
	...
	if needSensitiveCheck && meta != nil {
		...
		if contains {
			...
			newAPIError = types.NewError(fmt.Errorf("sensitive words detected: %s", strings.Join(words, ", ")), types.ErrorCodeSensitiveWordsDetected, types.ErrOptionWithStatusCode(http.StatusBadRequest), types.ErrOptionWithSkipRetry())
			return
		}
	}
