...
type ChannelOtherSettings struct {
	...
	AutomaticChannelTestDisabled          bool                       `json:"automatic_channel_test_disabled,omitempty"`
	AutoTestChannelIntervalMinutes        float64                    `json:"auto_test_channel_interval_minutes,omitempty"`
	...
	AutoBanRules                          *types.ChannelAutoBanRules `json:"auto_ban_rules,omitempty"`                             // 渠道级自动禁用规则，nil 表示跟随全局
