	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.GET("/self/model-channels", controller.GetUserModelChannels)
		...
		ratioSyncRoute.Use(middleware.RootAuth())
		{
			...
			ratioSyncRoute.POST("/official/preview", controller.PreviewSelectedOfficialPriceSync)
		...
		tokenRoute.Use(middleware.UserAuth())
		{
			...
			tokenRoute.GET("/stale_model_limits", controller.GetStaleTokenModelLimits)
			tokenRoute.POST("/stale_model_limits/cleanup", controller.CleanupStaleTokenModelLimits)
		}
		...
		logRoute.GET("/error_summary", middleware.AdminAuth(), controller.GetErrorLogSummary)
		logRoute.POST("/error_briefing", middleware.AdminAuth(), controller.GetErrorBriefing)
		...
		RegisterTokenUsageDataRoutes(apiRouter)
		...
		modelsRoute.Use(middleware.AdminAuth())
		{
			...
			modelsRoute.GET("/rule_coverage", controller.GetModelRuleCoverage)
			modelsRoute.POST("/rule_coverage/check", controller.CheckModelRuleCoverage)
			modelsRoute.GET("/pricing_health", controller.GetModelPricingHealth)
			modelsRoute.POST("/pricing_settings/cleanup", controller.CleanupStaleModelPricingSettings)
